...
public class PlaceOrderRegWhileCheckout {
	public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("sndhhiaQya@gmail.com");
        ...
        driver.findElement(By.id("address1")).sendKeys("123,Gopalan workspace,tekpyramid");
